...
# 压缩包名称 node-v8.9.1-linux-x64.tar.gz
ARCHIVE_FILE_NAME="${SOFTWARE_NAME}-v${SOFTWARE_VERSION}-linux-x64.tar.gz"

# 压缩包下载地址 https://nodejs.org/dist/v8.9.1/node-v8.9.1-linux-x64.tar.gz
ARCHIVE_FILE_DOWNLOAD_URL="https://nodejs.org/dist/v${SOFTWARE_VERSION}/${ARCHIVE_FILE_NAME}"

# 压缩包解压后的目录名称 node-v8.9.1-linux-x64
UNARCHIVE_DIR_NAME="${SOFTWARE_NAME}-v${SOFTWARE_VERSION}-linux-x64"
